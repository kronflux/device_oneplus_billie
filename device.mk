...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/rootdir/etc/fstab.default:$(TARGET_COPY_OUT_PRODUCT)/vendor_overlay/30/etc/fstab.default \
    $(LOCAL_PATH)/rootdir/etc/fstab.emmc:$(TARGET_COPY_OUT_PRODUCT)/vendor_overlay/30/etc/fstab.emmc
